...
draw_set_font(fnt_2)
    ...
    draw_set_halign(1)
        ...
        outline_draw_text_transformed_color(400, 260, "Where is the village?", 0.4, 0.4, 0, c_white, c_white, c_blue, c_blue, ((dsin(current_time/5)+1)/2))
...
// Text drawing pixel
draw_set_font(fnt_1)
    outline_draw_text_transformed_color(20, 20, "Quest: find the lumberjack.", 3, 3, 0, c_red, c_red, c_yellow, c_yellow, 1)
    ...
    outline_draw_text_transformed_color(20, 70+(dsin(current_time/8)*10), _time, 3, 3, 0, c_white, c_white, c_white, c_white, 1)
