...
OutlineStyleUpdate("style", thick, c_black, 1, roundness, 0.5, 1, true)
outline_draw_sprite_ext(spr_pixel, 0, 256, 256, 8, 8, 0, -1, 1, "style")
/*
//outline_draw_sprite_ext(spr_flag, current_time/100, 256, 256, 6, 6, 0, -1, 1)
draw_text(32, 32, $"{fps} - {fps_real}")
...
outline_draw_text_ext_transformed_color(32, 64, _text, 12, 300, 3, 3, 0, c_red, , , , 1)
//draw_set_valign(va)
//draw_set_halign(ha)
//var _ang = ang
