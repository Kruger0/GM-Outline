...
//outline_draw_sprite_ext(spr_flag, current_time/100, 256, 256, 6, 6, 0, -1, 1)
OutlineStyleUpdate("test", thick, c_black, 1, roundness, 0.5, 1, true)
//outline_draw_sprite_ext(spr_pixel, 0, 256, 256, 6, 6, 0, -1, 1, "test")
outline_draw_sprite_ext(spr_flag, current_time/100, 256, 256, 6, 6, 0, -1, 1, "test")
...
////outline_draw_surface_ext(surf, 0, 0, 3, 3, 0, -1, 1, ol_config(thick, c_black, 1, roundness))
////outline_end()
...
//outline_draw_text_ext_transformed_color(32, 96, _text, 12, 300, 3, 3, 0, c_red, , , , 1)
////draw_set_valign(va)
////draw_set_halign(ha)
////var _ang = ang
