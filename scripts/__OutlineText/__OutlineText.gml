...
/// @arg [style]        The style to use for the outline. Define it first before use
function outline_draw_text_ext(_x, _y, _string, _sep, _w, style = __OUTLINE_DEFAULT) {
    var _col = draw_get_color();
    outline_draw_text_ext_transformed_color(_x, _y, _string, _sep, _w, 1, 1, 0, _col, _col, _col, _col, draw_get_alpha(), style);
}
...
/// @arg alpha          The alpha of the string.
/// @arg [style]        The style to use for the outline. Define it first before use
function outline_draw_text_ext_color(_x, _y, _string, _sep, _w, _c1, _c2 = _c1, _c3 = _c1, _c4 = _c1, _a = 1, style = __OUTLINE_DEFAULT) {
    outline_draw_text_ext_transformed_color(_x, _y, _string, _sep, _w, 1, 1, 0, _c1, _c2, _c3, _c4, _a, style);
}
...
/// @arg angle          The angle of the string.
/// @arg [style]        The style to use for the outline. Define it first before use
function outline_draw_text_ext_transformed(_x, _y, _string, _sep, _w, _xscale, _yscale, _ang, style = __OUTLINE_DEFAULT) {
    var _col = draw_get_color();
    outline_draw_text_ext_transformed_color(_x, _y, _string, _sep, _w, _xscale, _yscale, _ang, _col, _col, _col, _col, draw_get_alpha(), style);
}
...
/// @arg alpha          The alpha of the string.
/// @arg [style]        The style to use for the outline. Define it first before use
function outline_draw_text_ext_transformed_color(_x, _y, _string, _sep, _w, _xscale, _yscale, _ang, _c1, _c2 = _c1, _c3 = _c1, _c4 = _c1, _a = 1, style = __OUTLINE_DEFAULT) {
    var _style      = OutlineStyleGet(style);
    var _halign     = draw_get_halign();
    var _valign     = draw_get_valign();
    var _gap        = max(_style.width, 0);
    ...
    outline_draw_surface_ext(_surf, _ox, _oy, _xscale, _yscale, _ang, c_white, 1.0, style);
}